...
| Лист | Содержимое |
|------|-----------|
| **Гидропост** | Год + посты (Qср годовые м³/с) |
| **Работа1** | Норма годового стока (расчётная река + аналог + площади) |
| **Работа2** | Внутригодовое распределение (помесячные расходы I–XII) |
...
| **Работа6** | Водный баланс (осадки / сток / испарение) |
| **Работа7** | Ливневый сток (параметры: площадь, климатическая зона) |
