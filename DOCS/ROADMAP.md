...
> Дальше — **P1 / HydroSphere 1.5**: этапы P1.1–P1.7 ниже; код P1 не начат.
...
- ≥ N новых методик (N фиксируем при старте этапа, ориентир 8–12) с тестами эквивалентности.
...
| 9.4 | Объём P1.4 (сколько методик) | ориентир 8–12 handler'ов; уточняется при старте | P1.4 |
