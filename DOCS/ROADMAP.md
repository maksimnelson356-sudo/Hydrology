...
>
> **Статус:** ТЗ, версия 2.5 · **Дата:** 23.09.2026 · **Ветка:** `global-implementation`
...
> **§6.3 P3 расписана** (этапы P3.1–P3.5, решения 11.1–11.3); код P3 не начат.
...
| Этап | Содержание | Ключевые артефакты | Оценка |
|------|------------|--------------------|--------|
| P3.1 | Многопролётная кривая подпора | `backwater_profile_service`, work9 GUI | ~2–3 дня |
| P3.2 | Muskingum-маршрутизация | `routing.py` + `routing_service`, GUI-гидрограф | ~2–3 дня |
...
| # | Вопрос | Варианты | Затронуло |
|---|--------|----------|-----------|
| 11.1 | Алгоритм маршрутизации 1D | (а) Muskingum (простой, стабильный, отраслевой стандарт) · (б) полноценный Saint-Venant (тяжело, новые зависимости) | P3.2 |
