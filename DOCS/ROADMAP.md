...
>
> **Статус:** ТЗ, версия 2.7 · **Дата:** 24.09.2026 · **Ветка:** `global-implementation`
...
> **§6.3 P3**: P3.1–P3.2 выполнены (`backwater_profile@1.0`, `muskingum@1.0`); P3.3–P3.5 не начаты; решение 11.1=(а) закрыто, 11.2–11.3 открыты.
...
| P3.3 | Затопление H → S,V | `inundation_service`, GUI-блок | ~2 дня |
...
| 11.2 | Источник S(H) для затопления | (а) кривая из `profile.build_curves` / таблицы стока · (б) elevation в properties GeoJSON-контуров · (в) DEM-растер (запрещён решением 9.3=б) | P3.3 |
