...
HIDDEN_IMPORTS = [
    ...
    "core.services.data_quality_service", "core.services.methodology_registry",
    "core.services.project_service", "core.services.report_service",
    ...
    "gui.tabs.tab_scenarios", "gui.tabs.tab_report",
