...
>
> **Статус:** ТЗ, версия 2.6 · **Дата:** 23.09.2026 · **Ветка:** `global-implementation`
...
> **§6.3 P3**: P3.1 выполнен (многопролётная ГВП, `backwater_profile@1.0`); P3.2–P3.5 не начаты; решения 11.1–11.3 открыты.
