...
> Дальше — **P1 / HydroSphere 1.5**: этапы P1.1–P1.7 ниже; **P1.1–P1.5 и P1.7 выполнены и запушены** (`6860165`), мёрдж в `main` выполнен; открыт P1.6.
...
|------|--------|-----------|
| 23.09.2026 | 2.0 | **P1.1–P1.5 + P1.7 выполнены и запушены** (`origin/global-implementation`, HEAD `6860165`); **мёрдж в `main` выполнен** (решение 8.2, fast-forward). Тесты: 217 pytest + 135 корневых; навигация 23/23/23; GUI smoke OK; 20 методик в реестре. P1.7: `scenario_type`, `ReservoirScenarioService`, `storage_yield`, GUI-блок водохранилища + Δ-таблица + баланс-график. Открыт P1.6 (решение 9.3) |
