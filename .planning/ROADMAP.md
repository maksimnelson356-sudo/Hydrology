...
>
> **Статус:** ТЗ, версия 2.1 · **Дата:** 23.09.2026 · **Ветка:** `global-implementation`
...
> Дальше — **P2 / HydroSphere 2.0**: этапы P2.1–P2.5 расписаны в **§6.2**; в работе **P2.1 Monte Carlo**.
...
| # | Вопрос | Варианты | Затронуло |
|---|--------|----------|-----------|
| 10.1 | Дистрибуции входов MC | (а) uniform + normal + triangular (закрыто: минимальный набор) · (б) расширить beta/lognormal | P2.1 |
| 10.2 | N по умолчанию в MC | (а) N=1000 (закрыто: быстро для GUI, seedable) · (б) N=10000 | P2.1 |
